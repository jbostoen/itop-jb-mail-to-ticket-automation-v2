...
class IMAPOAuthLogin extends Imap
{
	...
	protected $bHasDeletedMails = false;
	...
	public function logout()
	{
		...
		if ($this->bHasDeletedMails && !$this->expunge()) {
	...
	/**
	 * @param bool $bHasDeletedMails
	 */
	public function SetHasDeletedMails(bool $bHasDeletedMails)
	{
		$this->bHasDeletedMails = $bHasDeletedMails;
	}
