...
class TriggerOnMailProcessingEvent extends Trigger {
	...
	public static function Init() {
		...
		// The steps (MailProcessingEvent, e.g. "policy_no_subject") to subscribe to.
		MetaModel::Init_AddAttribute(new AttributeLinkedSetIndirect('steps_list', [
			'linked_class' => 'lnkMailProcessingEventToTrigger',
			'ext_key_to_me' => 'trigger_id',
			'ext_key_to_remote' => 'event_id',
			'count_min' => 0,
			'count_max' => 0,
			'duplicates' => false,
			'display_style' => '',
		...
		MetaModel::Init_AddAttribute(new AttributeEnum('include_original_message', [
