...
use JeffreyBostoenExtensions\MailToTicket\eNextAction;
...
abstract class EmailProcessor {
	 ...
	 * @return EmailSource[]
	 */
	abstract public function ListEmailSources() : array;
	 ...
	 * @return eNextAction
	 */
	abstract public function ProcessMessage(EmailSource $oSource, $index, EmailMessage $oEmail, EmailReplica $oEmailReplica, &$aErrors = array()) : eNextAction;
